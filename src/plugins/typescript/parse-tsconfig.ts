...
function loadTsConfig(configPath?: string, onDiagnostics?: (diagnostics: ts.Diagnostic[]) => void): ITsConfig {
...
export function parseTsConfig(
    ...
    const result = ts.parseJsonConfigFileContent(loadedConfig, ts.sys, baseDir, tsconfigOverride, configFileName);
